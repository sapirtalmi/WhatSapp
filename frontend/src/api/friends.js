...
export const acceptFriendRequest = (friendshipId) => api.put(`/friends/${friendshipId}/accept`).then((r) => r.data);
export const rejectFriendRequest = (friendshipId) => api.put(`/friends/${friendshipId}/reject`).then((r) => r.data);
export const removeFriend = (friendshipId) => api.delete(`/friends/${friendshipId}`);
export const searchUsers = (query) => api.get("/users/search", { params: { q: query } }).then((r) => r.data);
